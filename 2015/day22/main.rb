...
class Player
  attr_reader :hit_points, :physical_damage, :armor_stat, :og_hit_points, :mana, :og_mana

  def initialize(hit_points, damage, armour, mana)
...
class Game
  ...
  def initialize
    @player = Player.new(50, 0, 0, 500)
    @computer = Player.new(55, 8, 0, 0)
